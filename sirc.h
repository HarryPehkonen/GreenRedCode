...
#define SIRC_CODE_MASK      0b00000011111111111111111111111111
#define SIRC_IS_REPEAT_MASK 0b00000100000000000000000000000000
#define SIRC_LENGTH_MASK    0b11111000000000000000000000000000
#define SIRC_GET_IS_REPEAT(c) ((c) & SIRC_IS_REPEAT_MASK)
